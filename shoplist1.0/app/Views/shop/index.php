<p><h4>Läden</h4> <table class="table table-striped">
                      <thead>
                        <tr><th>
                           Name
                          </th>
                      ...
                      <tbody>
						...
						for($i=0;$i<count($this->outputdata)-1; $i++)
						{
							...
							if($i !== 0){?>
							<td> 
							<a href='http://<?php echo $_SERVER['HTTP_HOST'].'/'.PN; ?>/shop/edit/<?php echo $this->outputdata[$i]['id']; ?>'> <i class='fas fa-pen'></i></a>  
							&nbsp;&nbsp;&nbsp; 
							<a href='http://<?php echo $_SERVER['HTTP_HOST'].'/'.PN; ?>/shop/deleteByID/<?php echo $this->outputdata[$i]['id']; ?>'><i class='fas fa-trash'></i></a>
							</td> 
							<?php 
							}else {echo "<td></td>";}
							echo "</tr>";
					...
					<form action="http://<?php echo $_SERVER['HTTP_HOST'].'/'.PN; ?>/shop/neu" method="post">		
