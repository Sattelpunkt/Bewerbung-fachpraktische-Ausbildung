    ...
    if ($this->outputdata == false) {
        ...
        for ($i = 0; $i < count($this->outputdata) - 1; $i++) {
            ...
            if ($i !== 0) {
                ?>
                <td>
                    <a href='http://<?php echo $_SERVER['HTTP_HOST'] . '/' . PN; ?>/gebinde/edit/<?php echo $this->outputdata[$i]['id']; ?>'>
                        <i class='fas fa-pen'></i></a>
                    &nbsp;&nbsp;&nbsp;
                    <a href='http://<?php echo $_SERVER['HTTP_HOST'] . '/' . PN; ?>/gebinde/deleteByID/<?php echo $this->outputdata[$i]['id']; ?>'><i
...
<form action="http://<?php echo $_SERVER['HTTP_HOST'] . '/' . PN; ?>/gebinde/neu" method="post">
    <div class="row">
        <div class="col-5">
