<p><h4>Kategorien</h4> <table class="table table-striped">
                      ...
                      <tbody>
						...
						for($i=0;$i<count($this->outputdata)-1; $i++)
						{
							...
							if($i !== 0){?>
							<td>
							<a href='http://<?php echo $_SERVER['HTTP_HOST'].'/'.PN; ?>/truheKategorien/edit/<?php echo $this->outputdata[$i]['id']; ?>'> <i class='fas fa-pen'></i></a>
							&nbsp;&nbsp;&nbsp;
							<a href='http://<?php echo $_SERVER['HTTP_HOST'].'/'.PN; ?>/truheKategorien/deleteByID/<?php echo $this->outputdata[$i]['id']; ?>'><i class='fas fa-trash'></i></a>
							</td>
							<?php
							}else {echo "<td></td>";}
							echo "</tr>";
					...
					<form action="http://<?php echo $_SERVER['HTTP_HOST'].'/'.PN; ?>/truheKategorien/neu" method="post">
